      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            {!! Form::open(['method'=>'GET','url'=>'/bukti/export-excel','role'=>'search'])  !!}
              <input style="display: none" type="text" class="form-control float-left" name="no_lp" value="{{ $no_lp }}">
              <input style="display: none" type="text" class="form-control float-left" name="satker" value="{{ $satker }}">
              <input style="display: none" type="text" class="form-control float-left" name="jenis_pidana" value="{{ $jenis_pidana }}">
              <input style="display: none" type="text" class="form-control float-left" name="no_rangka" value="{{ $no_rangka }}">
              <input style="display: none" type="text" class="form-control float-left" name="no_mesin" value="{{ $no_mesin }}">
              <input style="display: none" type="text" class="form-control float-left" name="jenis_kendaraan" value="{{ $jenis_kendaraan }}">
	            <button title="Download Data" type="submit" class="btn btn-sm btn-info float-left">Download Data Bukti</button>
	          {!! Form::close() !!}
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <div class="col-md-12 table-responsive">
              ...
              <!-- Filter -->
              <thead>
                {!! Form::open(['method'=>'GET','url'=>'/bukti-lain-search','role'=>'search'])  !!}
                  <tr style="border: 0">
                  ...
                  <td>
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <a target="_blank" class="dropdown-item" href='{{URL::action("admin\BuktiLainController@show",array($data->perkara_id))}}'>Detail Perkara</a>
                      </div>
                    </div>
                  </td> 
                </tr>
