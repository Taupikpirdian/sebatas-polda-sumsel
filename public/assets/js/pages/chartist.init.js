! function(n) {
    ...
    n(function() {
        ...
        if (areaChart, n("#pieChart").length) {
            ...
            new Chart(o, {
                ...
                data: {
                    datasets: [{
                        data: [21, 16, 48, 31],
                        backgroundColor: ["#f96565", "#3051d3", "#00a7e1", "#e4cc37"],
                        borderColor: ["#f96565", "#3051d3", "#00a7e1", "#e4cc37"]
                    }],
        ...
        if (n("#donut-chart").length) o = n("#donut-chart").get(0).getContext("2d"), new Chart(o, {
            type: "pie",
            data: {
                datasets: [{
                    data: [21, 16, 48, 31],
