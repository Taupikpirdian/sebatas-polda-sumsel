...
class ProgressKejahatanService
{
    ...
    //       ->paginate(25);
    //   }
    //   return view('admin.perkara.from-dashboard.not_done',compact('perkaras', 'satker_param', 'jenis_kasus_param', 'tahun_param', 'search_bar'));
    // }
